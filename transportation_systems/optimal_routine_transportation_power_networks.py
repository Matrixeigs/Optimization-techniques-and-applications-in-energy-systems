...
"""
import os, platform
from numpy import zeros, hstack, concatenate, shape
from scipy.sparse import csr_matrix as sparse

from transportation_systems.test_cases.case6 import transportation_network
...
class OptimalRoutineTransPowerNetworks():
    """
    Optimal routine class for
    """

    def __init__(self):
        self.pwd = os.getcwd()

    def problem_formulation(self, transportation_networks, electricity_networks, traffic_demand):

        T = traffic_demand.shape[0]  # Dispatch horizon
...
if __name__ == "__main__":
    optimal_routine_trans_power_networks = OptimalRoutineTransPowerNetworks()
