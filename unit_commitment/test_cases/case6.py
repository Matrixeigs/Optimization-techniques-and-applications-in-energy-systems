...
def case6():
    ...
    ppc["gen"] = array([
        [1, 0, 0, 200, -80, 1, 100, 1, 220, 100, 0, 0, 0, 0, 0, 0, 55 / 12, 55 / 6, 0, 0, 0],
        [2, 100, 0, 70, -40, 1, 100, 1, 100, 10, 0, 0, 0, 0, 0, 0, 50 / 12, 50 / 6, 0, 0, 0],
        [6, 100, 0, 50, -40, 1, 100, 1, 20, 10, 0, 0, 0, 0, 0, 0, 20 / 12, 20 / 6, 0, 0, 0],
    ])
