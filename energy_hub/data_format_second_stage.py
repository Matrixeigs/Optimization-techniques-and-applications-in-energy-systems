...
PH_ABS = 8  # Positive derivation of heat supply
PH_RELAX = 9  # Positive derivation of heat supply
PC_ABS = 10  # Positive derivation of heat supply
PC_RELAX = 11  # Positive derivation of heat supply
