"""
Stochastic unit commitment with multiple microgrids, considering the start-up and shut-down of diesel generators
1) Two stage stochastic optimization is adopted, where the second stage is depicted by scenario
2) The decompostion method can be adopted, including generalized benders decomposition
"""
...
from distribution_system_optimization.data_format.idx_MG_UC import PBIC_AC2DC, IG, PG, PESS_DC, PBIC_DC2AC, PUG, \
    PESS_CH, RUG, RESS, RG, EESS, NX_MG, QBIC, QUG, QG, ALPHA, BETA


class UnitCommitmentTess():
    def __init__(self):
        self.name = "Unit commitment with branch power flow and mess"
    ...
    def problem_formulation_microgrid(self, micro_grid):
        """
        Unit commitment problem formulation of single micro_grid, the start-up and shut-down of generators should be considered.
        :param micro_grid:
        :return:
        """
...
if __name__ == "__main__":
    ...
    unit_commitment_tess = UnitCommitmentTess()

    (sol_dso, sol_mgs, sol_tess) = unit_commitment_tess.main(case=mpc, profile=load_profile.tolist(),
